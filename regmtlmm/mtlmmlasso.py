...
def mtlmmlasso(filename_pheno=None, filename_geno=None, filename_relatedness=None, maxiter=1, alpha=0.2):
    r"""
    Compute the mtlmm-L1 estimator
    ...
    for i in range(maxiter):
        ...
        # running lasso regression with desired sparsity level 
